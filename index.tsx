...
export class MyComponent extends React.Component<any, any> {
    ...
    private setDatePickerDialogReference(ref: any) {
        ...
        if (ref) {
            ...
            ref.handleWindowKeyUp = (...args: any[]) => console.log("Dialog tried to call handleWindowKeyUp.");
            ref.handleRequestClose = (...args: any[]) => console.log("Dialog tried to call handleRequestClose.");
        }
